...
helper = r'''def _first_silence_followup_plan(context: dict[str, Any], *, now: datetime) -> dict[str, Any] | None:
    ...
    first_name = _clean(quote.get("firstName"), 80) or "Hola"
...
needle = '''    if state == "PAUSED":\n'''
# no change here; insert fast path after paused block, immediately before evidence guard
